...
define('_MYPROFILEEMAILADDRESS',		'Stored email address');
...
define('_MYPROFILEMAILCHANGEREQUEST',	'An verification email has been sent to your old email address. Please note the instructions in this mail to activate your new email address');
